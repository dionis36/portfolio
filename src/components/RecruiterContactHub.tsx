...
import { Mail, MessageSquare, Copy, Check, MapPin, Clock } from "lucide-react";
    ...
    <section id="contact" className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3.5">
                  <div className="p-2.5 rounded-lg bg-white border border-gray-200 text-gray-700">
                    <Mail className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="text-[11px] font-mono text-gray-500">Direct Email</div>
                ...
                <div className="px-3 py-1 rounded-md bg-white border border-gray-200 text-xs font-mono text-gray-600 group-hover:text-gray-900 flex items-center gap-1">
                  {copiedEmail ? (
                    <>
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <div className="text-[11px] font-mono text-gray-500">WhatsApp / Phone</div>
                    <div className="text-sm font-semibold text-gray-900">
                      +255 719 231 593 / +255 754 794 174
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 p-3 rounded-xl bg-gray-50 border border-gray-200 hover:border-gray-300 text-gray-800 text-xs font-mono font-medium transition-all"
                >
        ...
        <footer className="mt-12 text-center text-xs font-mono text-gray-500 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-200 pt-6">
          <div>
            © {new Date().getFullYear()} Dionis Ludovick Nasuwa. Hosted on Vercel.
          </div>
